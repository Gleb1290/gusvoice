# GusVoice Individual Contributor License Agreement

*Version 1.0. Adapted from the Apache Software Foundation Individual Contributor License Agreement v2.2. This text has
not been reviewed by a lawyer.*

Thank you for your interest in contributing to GusVoice. To keep the project's licensing clear, every contributor
accepts this Agreement before their first contribution is merged. You accept it by following the instructions the CLA
bot posts on your pull request (a comment such as "I have read the CLA Document and I hereby sign the CLA"). It does
not change your rights to use your own Contributions for any other purpose.

**Why this agreement exists.** GusVoice is published under the GNU Affero General Public License v3 with an additional
permission (see [`LICENSING.md`](LICENSING.md)). This Agreement lets the Maintainer keep granting such permissions and
distribute the project — including your Contributions — under other license terms as well, for example a commercial
license, without having to find and ask every past contributor. Your Contributions remain available to everyone under
the AGPL in the public repository.
...
1. **Definitions.**
   ...
   "Maintainer" means the maintainer of the GusVoice project, the owner of the GitHub account `Gleb1290`, and any
   successor to whom the project is transferred.

   "You" (or "Your") means the copyright owner or legal entity authorized by the copyright owner that is making this
   Agreement with the Maintainer. For legal entities, the entity making a Contribution and all other entities that
   ...
   that is intentionally submitted by You to the Maintainer for inclusion in, or documentation of, GusVoice (the
   "Work"). For the purposes of this definition, "submitted" means any form of electronic, verbal, or written
   communication sent to the Maintainer or the project's representatives, including but not limited to pull requests,
   issues, and discussions in the project's repositories, but excluding communication that is conspicuously marked or
   otherwise designated in writing by You as "Not a Contribution."

2. **Grant of Copyright License.** Subject to the terms and conditions of this Agreement, You hereby grant to the
   Maintainer and to recipients of software distributed by the Maintainer a perpetual, worldwide, non-exclusive,
   no-charge, royalty-free, irrevocable copyright license to reproduce, prepare derivative works of, publicly display,
   publicly perform, sublicense, and distribute Your Contributions and such derivative works, under any license terms,
   including terms other than the GNU Affero General Public License.
...
3. **Grant of Patent License.** Subject to the terms and conditions of this Agreement, You hereby grant to the
   ...
   offer to sell, sell, import, and otherwise transfer the Work, where such license applies only to those patent claims
   ...
   Contribution, or the Work to which You have contributed, constitutes direct or contributory patent infringement,
